   ...
   var curentPageDisplay = $('#supCurentPageDisplay')//当前页码展示
    ...
    $('#supSearch').click(function () {
      ...
      var  endTime = $('#endTimeSup').val().replace('T',' ')
        ...
        supCurentPage = 1;
        supPageTitalNum = pageMode("febakSamMac",data,carListContain,curentPageDisplay,supCurentPage,1)
    ...
    $('#supPrePage').click(function () {
        ...
        if(supCurentPage == 1){
            return false
             ...
             supCurentPage -= 1;
             pageMode("febakSamMac",data,carListContain,curentPageDisplay,supCurentPage,1)
        }
...
//根据车牌号查找具体信息
    $("#supListContain").on('click','input',function () {
        ...
        var coordina = []
        var displayInfo = {}
         var result = ajaxDiy("pointSamMac",data)
